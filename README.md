...
- [**Edge Microvisor Toolkit Tiny**](standalone-node/emt_uos): contains the minimal
  ...
  To learn more about Tiny and its deployment, refer to
  [the documentation](https://github.com/open-edge-platform/edge-microvisor-toolkit/docs/developer-guide/emt-tiny.md).
