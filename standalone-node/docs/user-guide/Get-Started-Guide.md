...
> **Note:** This command will build the Edge Microvisor Toolkit Tiny and generate the
...
- Reboot the Standalone Node
  This will start the boot of Tiny OS, followed by Microvisor installations.
...
2. To track what caused the failure in provisioning of the microvisor from Tiny, check the
`/var/log/os-installer.log` file on Tiny OS.
